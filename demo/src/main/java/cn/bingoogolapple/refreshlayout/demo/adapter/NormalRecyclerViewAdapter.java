...
public class NormalRecyclerViewAdapter extends BGARecyclerViewAdapter<CateModel> {
    ...
    @Override
    public void fillData(BGAViewHolderHelper viewHolderHelper, int position, CateModel model) {
        viewHolderHelper.setText(R.id.tv_item_normal_title, model.getName()).setText(R.id.tv_item_normal_detail, model.getCate_id());
    }
}